<template>
  ...
  >
    <div class="modal">
      <!-- @slot Use it to add something to modal header. -->
      <slot name="header">
      ...
      <div class="modal-body">
        <OurCard>
          <div class="confirm-modal-description">
            <!-- @slot Use it to add something to modal description. -->
            <slot />
          </div>
        </OurCard>
      </div>
    ...
    <div class="footer">
      <OurButton data-cy="accept-button" :text="actionButtonText" @click="emitConfirmAction" />

      <OurButton variant="secondary" :text="i18n.cancel" @click="onCloseModal" />
    </div>
  </t-modal>
</template>
...
export default {
  ...
  computed: {
    ...
    i18n() {
      return {
        cancel: this.$te("component.confirmModal.cancel")
          ? this.$t("component.confirmModal.cancel")
          : this.$t("cancel"),
      };
    },
  },
